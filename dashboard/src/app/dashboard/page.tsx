...
export default function Dashboard() {
  return (
    <div className="relative flex h-full min-h-0 w-full max-w-full flex-col overflow-hidden bg-[#0A0F1E]">
      ...
      <div className="relative z-10 grid min-h-0 w-full max-w-full flex-1 grid-cols-[minmax(0,7fr)_minmax(0,8fr)_minmax(0,5fr)] gap-3 overflow-hidden p-3">
        {/* LEFT: CCTV + Stats */}
        <div className="flex min-h-0 min-w-0 flex-col gap-3 overflow-hidden">
          <CctvFeed
            ...
            boundingBoxes={[
              ...
              {
                id: "b3",
                positionClass: "top-[60%] left-[20%] w-20 h-10",
                variant: "error",
                label: "DEFECT: Crack (98%)",
              },
            ]}
          />
        ...
        <div className="flex min-h-0 min-w-0 flex-col gap-3 overflow-hidden">
          <RailwayDigitalTwin
            ...
            activeLayer="risk"
            trains={[
              { id: "t1", label: "T-402", positionClass: "top-[30%] left-[40%]", status: "normal" },
              { id: "t2", label: "T-119", positionClass: "top-[60%] left-[35%]", status: "normal" },
              { id: "t3", label: "T-882 (Delayed)", positionClass: "top-[45%] left-[55%]", status: "delayed" },
              {
                id: "t4",
                label: "T-991 (CRITICAL)",
                positionClass: "top-[70%] left-[65%]",
                status: "critical",
                size: "lg",
              },
            ]}
            ...
            alerts={[
              {
                id: "a1",
                severity: "critical",
                title: "CRITICAL: Obstruction Detected",
                timestamp: "14:05:12",
                description: "Unidentified object on Track 4, Sector B. Train T-991 approaching.",
                actions: [
                  { id: "halt", label: "HALT T-991", variant: "primary" },
                  { id: "cam", label: "VIEW CAM", variant: "secondary" },
                ],
              },
              {
                id: "a2",
                severity: "high",
                title: "HIGH: Signal Degradation",
                timestamp: "13:58:44",
                description: "Telemetry packet loss > 15% on Node 42.",
              },
              {
                id: "a3",
                severity: "medium",
                title: "MED: Passenger Flow Congestion",
                timestamp: "13:45:01",
                description: "Platform 2 exceeding capacity threshold.",
              },
            ]}
          />
        </div>
        ...
        <div className="min-h-0 min-w-0 overflow-hidden">
          ...
          steps={[
            {
              id: "s1",
              title: "Analyzing traffic pattern",
              timestamp: "14:02",
              description: "Ingesting multi-modal sensor data from Sector B.",
            },
            {
              id: "s2",
              title: "Identifying potential delay",
              timestamp: "14:03",
              description: "Correlated obstruction alert with T-991 trajectory.",
            },
            {
              id: "s3",
              title: "Retrieving historical context",
              timestamp: "14:04",
              description: "RAG RETRIEVAL: Found 3 similar incidents (2021, 2022).",
              variant: "rag",
            },
            {
              id: "s4",
              title: "Proposing reroute",
              timestamp: "14:05",
              description: "",
              variant: "proposal",
              proposal: {
                text: "Recommendation: Divert T-991 to Track 5 via Switch 12A.",
