...
export default function Dashboard() {
  ...
  return (
    <div className="relative flex h-full min-h-0 w-full max-w-full flex-col overflow-hidden bg-[#0A0F1E]">
      ...
      <div className="relative z-10 flex min-h-0 w-full max-w-full flex-1 flex-col gap-3 overflow-y-auto p-3 lg:grid lg:grid-cols-[minmax(0,7fr)_minmax(0,8fr)_minmax(0,5fr)]">
        {/* LEFT: CCTV + Stats */}
